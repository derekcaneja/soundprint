...
var toneMatrix1 = new ToneMatrix({ width: squareSize, height: squareSize, color: '#3498DB', instrument: bassSynth, matrix: synthMatrixFinal, title: 'Bass', gridcolor: '#2980B9', number: 1, display: true });
